...
const Navbar = () => {
  ...
  return (
    <div className='flex items-center justify-between py-5 font-medium'>
       ...
       <Link to= '/'> <img src= {assets.logo} className='w-36 -mt-5 ' alt="" /></Link>
        ...
        <div className='flex items-center gap-6'> 
            ...
            <div className='group relative'>
                <img onClick = {(s) => token ? null : navigate('/login') } src={assets.profile_icon} className='w-5 cursor-pointer' alt="" /> 
                {/* DropDown Menu */}
                {/* display drop down only when you logged in */}
